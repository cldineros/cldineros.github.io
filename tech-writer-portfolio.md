...
**Live samples**: 
- [Product data specification](https://support.google.com/merchants/answer/7052112) (Main article with 9 modular content IDs)
- [I need help fixing my shipping information in Merchant Center](https://support.google.com/merchants/troubleshooter/12762503) (Troubleshooter/Wizard article)
- [Shipping [shipping]](https://support.google.com/merchants/answer/6324436) (Sample attribute article) 
...
- **Metric**: Led in scoping 200+ diagnostics UI content and updating 19 policy articles to improve user comprehension and Google Ads and Shopping policy compliance under tight deadlines. Contributed 25 data quality diagnostics UI content under tight deadlines. Successfully met the tight July 28 deadline for the scoping phase and trained 100% of the Commerce MNL writers on the new framework. The resulting training materials were so effective they were adopted as mandatory "Connect Training" for all Commerce writers and QAs globally across MNL, HYD, and MIS sites
- **Methodology**: Utilized Functional Minimalism and Error Message Engineering to distill intricate regulatory jargon into actionable microcopy. Engineered a comprehensive training, scoping, triaging, and allocating framework to identify critical information gaps in existing Merchant Center external troubleshooting articles. This involved a strategic integration process where past diagnostics UI content were mapped against live documentation to ensure technical and instructional accuracy.

**Live samples**: 
- [Diagnostics UI Content](https://docs.google.com/presentation/d/1wyZlae4GhSp5MYjbUSpubkkZY2rhLcmdl9vE4YetzRA/edit?usp=sharing) (as they appear in Google Merchant Center)
- [UI Diagnostics-How to Fix articles Integration](https://docs.google.com/presentation/d/1Z-B6A2u0ap9wLm_dZ-cNEr8fWnKh5Jzgc1i0pKld3UQ/edit?usp=sharing) (Training deck) 
...
**Live samples**: 
- [Tech Writing Triaging & Stakeholder Communication](https://docs.google.com/presentation/d/1i00Rs8qpsB5SKDxgq7sB1fIvRkqoFLmDg6g_aIiXe_Q/edit?usp=sharing)
- [Triaging training deck](https://docs.google.com/presentation/d/1U60XTnfTmQmAevK2qexN_rVJKA_okgw0/edit?usp=sharing&ouid=105135708765793496768&rtpof=true&sd=true)

---

## Awards & Recognition
*   **Star Award (2025):** "Claire consistently goes beyond her role... project managing critical launches, mentoring writers across sites, and improving team operations and morale through proactive leadership"
*   **Star Award (2024):** Recognised as a top performer for maintaining a perfect scorecard while balancing multiple leadership roles, including **Content Request Triager** and **Product Area Lead**
*   **High Five Award:** For "outstanding dedication... showcasing the ability to perform under pressure while maintaining high-quality standards"
*   **Better Together Award:** For leading the **Integration training** and sharing materials globally with writers in Manila, Hyderabad, and Mississippi.
